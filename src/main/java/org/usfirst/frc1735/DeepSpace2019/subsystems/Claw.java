...
public class Claw extends Subsystem {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        //setDefaultCommand(new BallRetain());
    }
...
// Set to true to arm the ball retainer system implemented in BallRetain.java
public void armBallRetainer(boolean state) {
    this.ballRetentionIsArmed = state;
}

// Return whether the ball retainer state should be "armed"
public boolean ballRetainIsArmed() {
    return this.ballRetentionIsArmed;
}
    ...
    boolean ballRetentionIsArmed = false;
}
