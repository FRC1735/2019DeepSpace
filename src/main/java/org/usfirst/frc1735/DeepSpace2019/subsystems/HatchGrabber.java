    ...
    public void initHatchGrabber() {
        ...
        if (true /* !Robot.isPracticeBot() */) {
            ...
            // already exist.
              ...
              .getEntry(); m_hatchGrabberEncoderEntry.setDouble(hatchGrabberMotor.
            ...
            // Used by the HatchGrabOpenMove command button
              ...
              m_hatchGrabberMotorOpenMagdirEntry = m_alienTab.add("Hatch Motor", 0)
                 .withSize(8, 1) // make the widget 10x1 .withPosition(2, 0) // place it in the top-left corner 
