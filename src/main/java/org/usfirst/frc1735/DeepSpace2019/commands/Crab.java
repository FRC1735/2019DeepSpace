...
public class Crab extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        addSequential(new DriveWithPID(-4.5, ActiveSide.LEFT));
        addSequential(new DriveWithPID(-4.5, ActiveSide.RIGHT));
        addSequential(new DriveWithPID(4.5, ActiveSide.BOTH));
