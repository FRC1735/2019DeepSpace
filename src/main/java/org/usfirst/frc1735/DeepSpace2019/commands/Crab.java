...
public class Crab extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        final double crabDistance = 9;
        addSequential(new DriveWithPID(-crabDistance, ActiveSide.LEFT));
        //addSequential(new DriveWithPID(-crabDistance, ActiveSide.RIGHT));
        //addSequential(new DriveWithPID(crabDistance, ActiveSide.BOTH));
