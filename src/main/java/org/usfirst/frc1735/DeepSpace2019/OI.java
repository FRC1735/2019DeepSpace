...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("AlienRetractedClosed2", new AlienRetractedClosed());
        SmartDashboard.putData("AlienExtendedClosed2", new AlienExtendedClosed());
        SmartDashboard.putData("AlienExtendedOpen2", new AlienExtendedOpen());
