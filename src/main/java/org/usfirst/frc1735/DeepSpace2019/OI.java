...
import org.usfirst.frc1735.DeepSpace2019.commands.ArmWithRotarySwitch;
...
import org.usfirst.frc1735.DeepSpace2019.commands.WriteArmPIDFromSlotToSD;
...
public class OI {
    ...
    public JoystickButton launchPadRetractedClosed;
    public JoystickButton launchPadExtendedClosed;
    public JoystickButton launchPadExtendedOpen; 
    public JoystickButton climbExtend; 
    ...
    public OI() {
        ...
        // Commenting these guys out to reduce data load, since we are in a competition
        // and might need these later, I am not removing them in Robot Builder so they will
        // come back if RB is run
        /*
    ...
    // Same - except this one won't come back
    // SmartDashboard.putData("ArmWithRotarySwitch", new ArmWithRotarySwitch());
