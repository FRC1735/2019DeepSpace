...
public class OI {
    ...
    public OI() {
        ...
        releaseHatch = new JoystickButton(operator, 32);
        releaseHatch.whenPressed(new HatchManipulator(0));
        grabHatch = new JoystickButton(operator, 32);
        grabHatch.whenPressed(new HatchManipulator(0));
        alienAttack = new JoystickButton(operator, 32);
        alienAttack.whenPressed(new AlienDeploy(0));
        alienRetreat = new JoystickButton(operator, 32);
        alienRetreat.whenPressed(new AlienDeploy(0));
